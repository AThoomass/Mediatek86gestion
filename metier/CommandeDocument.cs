...
namespace Mediatek86.metier
{
    ...
    public class CommandeDocument : Commande
    {
        ...
        public CommandeDocument(string id, DateTime dateCommande, double montant ,int nbExemplaires, int idSuivi, string libelleSuivi, string idLivreDvd) : base(id, dateCommande, montant)
        {
